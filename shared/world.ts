...
function buildSalon(): MapDef {
  ...
  return {
    ...
    lights: [
      ...
      { x: 22 * T, y: 26 * T, r: 130, color: '255,214,150', flicker: 0.03, intensity: 0.75 },
      { x: 16 * T, y: 9 * T, r: 110, color: '255,200,140', flicker: 0.04, intensity: 0.6 },
      { x: 28 * T, y: 9 * T, r: 110, color: '255,200,140', flicker: 0.04, intensity: 0.6 },
      { x: 16 * T, y: 20 * T, r: 100, color: '255,200,140', flicker: 0.04, intensity: 0.55 },
      { x: 28 * T, y: 20 * T, r: 100, color: '255,200,140', flicker: 0.04, intensity: 0.55 },
